    ...
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="厂区" prop="factoryName">
        <el-select v-model="queryParams.factoryName" placeholder="请输入厂区" clearable @change="handleQuery">
          <el-option v-for="factory in factoryNameOptions" :key="factory.id" :label="factory.name" :value="factory.name"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item label="车间" prop="groupName">
        <el-select v-model="queryParams.groupName" placeholder="请输入车间" clearable @focus="getGroupNames" @change="handleQuery">
          <el-option v-for="groupName in groupNameOptions" style="width: 240px" :key="groupName.id" :label="groupName.name" :value="groupName.name"></el-option>
        </el-select>
      </el-form-item>
      ...
      <el-form-item label="点检状态" prop="code">
        <el-select v-model="queryParams.code" placeholder="请输入比对结果状态" clearable @change="dataChange">
          <el-option
...
import { fetchLatestFactoryNames, fetchLatestGroupNames, listLatestCheckStatus } from '@/api/biz/aa/statistics/statistics'
